...
import com.fermine.umweltlite.impl.engine.body.engine.BodyEngine;
import com.fermine.umweltlite.impl.engine.emotion.engine.EmotionalEngine;
import com.fermine.umweltlite.impl.engine.knowledge.engine.KnowledgeEngine;
import com.fermine.umweltlite.impl.engine.memory.engine.MemoryEngine;
import com.fermine.umweltlite.impl.engine.personality.engine.PersonalityEngine;
import com.fermine.umweltlite.impl.engine.sensory.engine.SensoryEngine;
...
public class UmweltEngine {
    ...
    public StorageInsert tick(Mob mob) {
        ...
        for (UmweltProcessor processor : this.processors) {
            ...
            if (this.isExhausted && processor.priority() > 20) {
                continue;
            }
